...
module.exports.getRenderedTemplate = function(body,routeType,callback){
    switch(routeType){
        case 'addPlacement': renderTemplate('./views/emails/addPlacement.ejs',body.templateData,function(html){
                                callback(html);
                            });
                             break;
                             
        case 'updatePlacement': renderTemplate('./views/emails/addPlacement.ejs',body.templateData,function(html){
                                    callback(html);
                                });
                                break;
                             
        case 'addInternship': renderTemplate('./views/emails/updatePlacement.ejs',body.templateData,function(html){
                                    callback(html);
                                });
                              break;
                             
        case 'updateInternship': renderTemplate('./views/emails/updatePlacement.ejs',body.templateData,function(html){
                                    callback(html);
                                });
                                 break;
    }
